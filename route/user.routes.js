...
const {
  verifyTokenFirebase,
  isAdminFirebase,
} = require("../middleware/firebaseMDL");
const {
  uploadImageFirestore,
  Mluter,
} = require("../services/HandleUploadService");
...
router.get("/get_Calender_available", get_Calender_available);
...
router.post(
  "/upload-avatar-user",
  [Mluter.single("image"), verifyTokenFirebase, uploadImageFirestore],
  userUploadAvatar
);
//create user
