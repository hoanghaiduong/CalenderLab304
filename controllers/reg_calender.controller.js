...
const accpet_Reg_Calender = (req, res) => {
  try {
    ...
    res.status(500).send({
      message:
        error.message || "Some error occurred while updating Reg_Calender.",
    });
  }
};
//đăng kí lịch
          ...
          Reg_Calender.update(
            {
              ...
              isActive:
                req.body.status_active == 1
                  ? false
                  : req.body.status_active == 2
                  ? true
                  : req.body.status_active == 3
                  ? false
                  : false,
...
const delete_reg_calender = (req, res) => {
  try {
    ...
    res.status(500).send({
      message:
        error.message || "Some error occurred while deleting Reg_Calender.",
    });
  }
};
...
const get_reg_calender = (req, res) => {
  ...
  try {
    ...
    res.status(500).send({
      message:
        error.message || "Some error occurred while retrieving Reg_Calender.",
    });
  }
